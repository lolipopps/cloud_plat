...
import com.cloud.plat.common.security.handler.AbstractLogoutSuccessEventHandler;
...
public class PigLogoutSuccessEventHandler extends AbstractLogoutSuccessEventHandler {
	...
	public void handle(Authentication authentication) {
		...
		// logVo.setMapToParams(authenticationDetails == null ? null : authenticationDetails.getTokenValue());
		// 发送异步日志事件
