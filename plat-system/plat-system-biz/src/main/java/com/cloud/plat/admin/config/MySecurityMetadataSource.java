package com.cloud.plat.admin.config;
...
public class MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public void loadResourceDefine() {
        ...
        ConfigAttribute cfg;
        // 获取启用的权限操作请求
        List<SysMenu> permissions = sysMenuService.findByTypeAndStatusOrderBySortOrder(CommonConstant.PERMISSION_OPERATION, CommonConstants.STATUS_NORMAL);
